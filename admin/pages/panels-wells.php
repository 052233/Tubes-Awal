                ...
                <div class="container-fluid">
                    ...
                    <h2 class=>Data Akun</h2>
                        ...
                        foreach($hasil as $data){
                            ...
                            echo"<input type='text' hidden name='id' value='$data[id]'>";
                            echo"<button type='submit' name='btnsimpan' class='btn btn-success'>Edit</button>";
                            echo"</form>";
                            echo"</td>";
                            echo"</tr>";
                        ...
                        <?php
                            ...
                            if (isset($_POST['btnsimpan'])) {
                                ...
                                // Tambahkan proses penyuntingan kolom lain sesuai kebutuhan
                            
                                // Perintah SQL untuk melakukan penyuntingan
                                $query = "UPDATE anggota SET username='$username' WHERE id=$id";
                                $result = mysqli_query($koneksi, $query);
                            
                                if ($result) {
                                    echo "<p class='alert alert-success'><b>Data Berhasil Diupdate</b></p>";
                                } else {
                                    echo "<p class='alert alert-danger'><b>Data Gagal Diupdate</b></p>";
                                }
                            }
                        ?>
                    </div>
